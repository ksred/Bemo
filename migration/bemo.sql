...
CREATE TABLE IF NOT EXISTS `artist` (
  ...
  `social_lastfm` int(1) NOT NULL DEFAULT '0',
  `social_youtube` int(1) NOT NULL DEFAULT '0',
  `social_vimeo` int(1) NOT NULL DEFAULT '0',
  `social_soundcloud` int(1) NOT NULL DEFAULT '0',
  `social_bandcamp` int(1) NOT NULL DEFAULT '0',
  `social_facebook` int(1) NOT NULL DEFAULT '0',
  `social_twitter` int(1) NOT NULL DEFAULT '0',
